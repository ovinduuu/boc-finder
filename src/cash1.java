 ...
 * @author ovidu
 */
public class cash1 extends javax.swing.JFrame {

    /**
     * Creates new form cash1
     */
    public cash1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Voucher Bundles Packing");
        ...
        jLabel1.setText("Voucher Bundles Packing");
        ...
        jButton3.setText("Sent for Approval");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cash1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void dataentry() {
        try{
            ...
            String sql = "insert into tcash (date, cupno, rowno) values (?,?,?)";
