 ...
 * @author ovidu
 */
public class spbu extends javax.swing.JFrame {

    /**
     * Creates new form spbu
     */
    public spbu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Mandate");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="select * from pbu where accno=?";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(spbu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
